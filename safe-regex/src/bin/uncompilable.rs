/// This takes >30 mins to compile on a 2.3 GHz 4-core i5 with 16 GB RAM.
///
/// ```
/// $ time cargo build --package safe-regex --bin uncompilable --release
/// ```
fn main() {
    let re = {
    ...
    re.match_all(b"aaaaaaaaaaaaaaaaaaaa").unwrap();
}
